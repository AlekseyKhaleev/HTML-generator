...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.generate_btn.setGeometry(QRect(590, 290, 75, 24))
        ...
        self.save_btn.setGeometry(QRect(760, 290, 71, 24))
        ...
        self.inline_check.setGeometry(QRect(750, 220, 76, 20))
        self.clear_btn = QPushButton(self.centralwidget)
        self.clear_btn.setObjectName(u"clear_btn")
        self.clear_btn.setGeometry(QRect(670, 290, 81, 24))
        ...
        self.border_check = QCheckBox(self.centralwidget)
        self.border_check.setObjectName(u"border_check")
        self.border_check.setGeometry(QRect(750, 240, 76, 20))
